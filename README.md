...
Le joueur incarne un personnage qui doit traverser 6 niveaux volontairement bugués, guidé par un narrateur . Les bugs deviennent des mécaniques de gameplay : plateformes imprévisibles, textures instables, labyrinthes impossibles, énigmes absurdes, et bruitages créés… à la main (ou via soundboard).  
...
**Adrien Moreau** - **Gameplay Programmer**  
  
**Quentin Lopes** - **Gameplay Programmer**  
  
**Charly Eury** - **GamePlay Programmer**  
  
**Maxime Luhat**  - **Gameplay Programmer**   
  
**Mathieu Panza** - **Gameplay Programmer**   
...
parcours / platforming,  
  
labyrinthe chaotique,  
  
énigmes volontairement illogiques,  
  
défis basés sur des comportements "buggés".  
...
ou produits via un soundboard improvisé.  
...
direction artistique volontairement simple,  
...
Explorer comment transformer un bug en fonctionnalité.  
  
Travailler en équipe sur Unreal Engine.  
  
Prototyper rapidement des mécaniques absurdes mais cohérentes.  
...
Level design itératif  
  
Trigger systems & puzzles  
  
Soundboard / bruitages manuels  
